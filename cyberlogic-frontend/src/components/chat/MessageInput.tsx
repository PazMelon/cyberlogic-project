  ...
  if (isActivityLog) {
    return (
      <div className="p-4 border-t border-border bg-surface-900/30 flex-shrink-0 relative">
        <div className="flex items-center justify-center gap-2 p-3 rounded-xl bg-surface-900 border border-border/80 text-xs text-text-muted text-center select-none font-medium italic">
          <span>📋 This is an automated system channel. Messages are generated by the Activity Log bot.</span>
        </div>
      </div>
    );
  }
