...
import {
  X, Link2, Image as ImageIcon, FileText, Plus,
  FolderKanban, UploadCloud, Sparkles, Layers, Globe, Search, RefreshCw, Info
} from "lucide-react";
import {
...
import MediaAssetCard from "./subcomponents/MediaAssetCard";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {filteredAssets.map((asset) => (
          <MediaAssetCard
            ...
            asset={asset as any}
            copiedId={copiedId}
            onCopyUrl={(att) => handleCopyLink(att.url, att.id)}
