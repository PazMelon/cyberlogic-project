      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-surface-900 items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-md px-12 text-center">
          ...
          <div className="space-y-4 text-left">
            {[
              { icon: Terminal, label: "Interactive Forums", desc: "Discuss, share knowledge, and help each other" },
              { icon: Mail, label: "Real-time Chat", desc: "Connect instantly with fellow members" },
              { icon: Shield, label: "Secure Portal", desc: "Your data is safe with industry-grade encryption" },
            ].map((feature) => (
              <div key={feature.label} className="flex items-start gap-3 glass rounded-xl p-3">
