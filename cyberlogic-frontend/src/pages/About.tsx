                      ...
                      >
                        <div className="glass rounded-2xl p-6 text-center hover:border-accent/30 hover:shadow-lg hover:shadow-accent/5 transition-all duration-300 h-full flex flex-col justify-between">
                          <div>
                            ...
                            {(member.department || member.year_level) && (
                              <div className="flex items-center justify-center gap-1.5 flex-wrap text-[10px] text-text-muted font-medium mt-1">
                                {member.department && (
                          ...
                          {(member.email || member.facebook || member.instagram || member.wechat || member.tiktok || member.twitter || member.reddit || member.github || member.linkedin) && (
                            <div className="pt-3 mt-3 border-t border-border/30 flex items-center justify-center gap-2 flex-wrap">
                              {member.email && (
                                <a
                                  href={`mailto:${member.email}`}
                                  onClick={(e) => e.stopPropagation()}
                                  className="w-7 h-7 rounded-lg bg-surface-800 border border-border flex items-center justify-center text-text-muted hover:text-primary hover:border-primary/30 transition-all duration-200"
                                  title="Email"
                                >
                              ...
                              {member.facebook && (
                                <a
                                  ...
                                  className="px-1.5 py-1 rounded-lg bg-surface-800 border border-border text-[10px] text-blue-400 font-bold hover:border-blue-500/40 transition-all"
                                  title="Facebook"
                                >
                                  FB
                                </a>
                              ...
                              {member.instagram && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="px-1.5 py-1 rounded-lg bg-surface-800 border border-border text-[10px] text-pink-400 font-bold hover:border-pink-500/40 transition-all"
                                  title="Instagram"
                                >
                                  IG
                                </a>
                              ...
                              {member.wechat && (
                                <a
                                  href={member.wechat.startsWith("http") ? member.wechat : `weixin://dl/chat?${member.wechat}`}
                                  onClick={(e) => e.stopPropagation()}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="px-1.5 py-1 rounded-lg bg-surface-800 border border-border text-[10px] text-emerald-400 font-bold hover:border-emerald-500/40 transition-all"
                                  title="WeChat"
                                >
                                  WeChat
                                </a>
                              ...
                              {member.tiktok && (
                                <a
                                  href={member.tiktok.startsWith("http") ? member.tiktok : `https://${member.tiktok}`}
                                  onClick={(e) => e.stopPropagation()}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="px-1.5 py-1 rounded-lg bg-surface-800 border border-border text-[10px] text-cyan-400 font-bold hover:border-cyan-500/40 transition-all"
                                  title="TikTok"
                                >
                                  TikTok
                                </a>
                              ...
                              {member.twitter && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="px-1.5 py-1 rounded-lg bg-surface-800 border border-border text-[10px] text-sky-400 font-bold hover:border-sky-500/40 transition-all"
                                  title="X (Twitter)"
                                >
                                  X
                                </a>
                              ...
                              {member.reddit && (
                                <a
                                  href={member.reddit.startsWith("http") ? member.reddit : `https://${member.reddit}`}
                                  onClick={(e) => e.stopPropagation()}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="px-1.5 py-1 rounded-lg bg-surface-800 border border-border text-[10px] text-orange-400 font-bold hover:border-orange-500/40 transition-all"
                                  title="Reddit"
                                >
                                  Reddit
                                </a>
                              ...
                              {member.github && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="w-7 h-7 rounded-lg bg-surface-800 border border-border flex items-center justify-center text-text-muted hover:text-purple-400 hover:border-purple-500/30 transition-all duration-200"
                                  title="GitHub"
                                >
                              ...
                              {member.linkedin && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="w-7 h-7 rounded-lg bg-surface-800 border border-border flex items-center justify-center text-text-muted hover:text-blue-500 hover:border-blue-500/30 transition-all duration-200"
                                  title="LinkedIn"
                                >
                                  <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
